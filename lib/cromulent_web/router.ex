defmodule CromulentWeb.Router do
  use CromulentWeb, :router

  import CromulentWeb.UserAuth
  ...
  if Application.compile_env(:cromulent, :dev_routes) do
    ...
    scope "/dev" do
      ...
      live_dashboard "/dashboard", metrics: CromulentWeb.Telemetry
  ...
  scope "/", CromulentWeb do
    ...
    live_session :redirect_if_user_is_authenticated,
      on_mount: [{CromulentWeb.UserAuth, :redirect_if_user_is_authenticated}] do
  ...
  scope "/", CromulentWeb do
    ...
    live_session :current_user,
      on_mount: [{CromulentWeb.UserAuth, :mount_current_user}] do
